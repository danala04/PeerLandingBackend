    ...
    public partial class InitializeCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrnFundings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrnFundings_mst_loans_loan_id",
                        column: x => x.loan_id,
                        principalTable: "mst_loans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrnFundings_mst_user_lender_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrnFundings_lender_id",
                table: "TrnFundings",
                column: "lender_id");

            migrationBuilder.CreateIndex(
                name: "IX_TrnFundings_loan_id",
                table: "TrnFundings",
                column: "loan_id");
        }
